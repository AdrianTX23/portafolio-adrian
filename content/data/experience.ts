...
export const experience: Experience[] = [
  {
    ...
    highlights: {
      es: [
        ...
        "Participé en proyectos desarrollados para Sura.",
        "Trabajé de forma colaborativa con equipos de desarrollo y análisis.",
      ],
      en: [
        ...
        "Contributed to projects developed for Sura.",
        "Worked collaboratively with development and analysis teams.",
      ],
    },
  ...
  },
  {
    ...
    highlights: {
      es: [
        ...
        "Participé en el diseño e implementación de nuevas funcionalidades.",
      ],
      en: [
